...
function RecipeIngredientCard({
  ...
  return (
    <fieldset className="grid min-w-0 grid-cols-1 [min-inline-size:0] gap-5 border border-slate-200 bg-stone-50 p-4 sm:p-5" data-row-key={ingredient.row_key} data-testid="recipe-ingredient">
