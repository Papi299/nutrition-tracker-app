...
test bodies. The candidate map contains 217 automated links and 699 evidence-
axis claims. It removes the CJ-028 miss-only no-JavaScript reference and nine
unsupported axis assignments, adds 49 existing-test references with 165
...
| Automated evidence-axis claims | 699 |
