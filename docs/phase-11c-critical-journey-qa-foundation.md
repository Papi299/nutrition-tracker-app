...
candidate adds one deterministic sign-out failure/retry reference with seven
...
isolation overclaims plus the new candidate overclaim. CJ-030 Option A, CJ-031
Phase 11D/11J ownership, every later-slice boundary, and no-JavaScript totals
`6 / 1 / 10 / 18` remain unchanged.
